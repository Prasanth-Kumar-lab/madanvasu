...
// import 'Rented_properties_controller.dart';
//
// class RentedProperties extends StatelessWidget {
...
//
//     for (String key in SharedPrefHelper.userKeys) {
...
//     final controller = Get.find<Rented_PropertiesController>();
//
...
//                   return CircularProgressIndicator(); // or a loading skeleton
...
//                     );
//                   },
//                   // userId: userData['userId'] ?? '', // use value from SharedPrefs
...
class RentedProperties extends StatelessWidget {
  ...
  // Fetch villageId from shared preferences
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<String?>(
      ...
      builder: (context, snapshot) {
        ...
        debugPrint(' RentedProperties User Village ID: $userVillageId');

...
//     if (selectedCategory.value?.id != categoryData?.id) {
...
//         propertyStatusController.text.isEmpty ||
...
//       print('API Response: ${response.statusCode}, Body: $responseBody');
//
...
//         width: 200, // Make dialog smaller initially
...
//                       child: ListTile(
//                         title: Text('ID: ${p.id}', style: const TextStyle(fontWeight: FontWeight.bold)),
//                         subtitle: Text('Charge: ${p.forDayCharge}', style: const TextStyle(color: Colors.grey)),
//                       ),
//                     );
//                   },
//                 ),
